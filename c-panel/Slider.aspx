                                    ...
                                    <asp:Panel ID="pnlConfirm" runat="server" Visible="false">
                                        ...
                                        <div class="input-in">
                                            <asp:Panel runat="server" ID="pnlCancel">
                                                <a id="cmdCancel" href="#" title="Cancel" class="btn btn-danger" data-toggle="modal" data-placement="bottom" data-original-title="Cancel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <div class="input-in col-md-6">
                                        <div class="input-group">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" type="text" placeholder="Search by Title" AutoPostBack="true" OnTextChanged="FillGrid" onkeypress="return isString(event);" onkeyup="ValidateChars(this);ShowHideClearSearch(this.value);" ToolTip="Search by Title"></asp:TextBox>
                            ...
                            <div class="p-lr-3">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="gvSlider" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="false" AllowSorting="true" OnPageIndexChanging="gvSlider_PageIndexChanging"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Title" SortExpression="Title" HeaderStyle-CssClass="upnDownArrow">
                                                <ItemTemplate>
