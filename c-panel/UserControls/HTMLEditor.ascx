    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <span style="text-align: center; font-family: Arial; font-size: 19px;">Description</span>
        ...
        <asp:HtmlEditorExtender ID="ed" TargetControlID="txtEd" runat="server" EnableSanitization="false" Enabled="True" ClientIDMode="AutoID"></asp:HtmlEditorExtender>--%>
            ...
            <div class="modal-footer">
                <span style="position: relative;">
                    ...
                    <asp:Button CssClass="btn-main btn-green btn-save" ID="btnSave" runat="server" Text="Save and Close" ClientIDMode="AutoID" />
                </span>
                <span style="position: relative;">
                    <i class="ti-close icon-save"></i>
                    <asp:Button CssClass="btn-main btn-red btn-save" ID="btnCancel" runat="server" Text="Cancel and Close" ClientIDMode="AutoID" />
                </span>
            </div>
        </div>
    </div>
