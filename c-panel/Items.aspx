                    ...
                    <div class="container-fluid">
                        <div class="uploader">
                            <asp:UpdateProgress ID="upg" runat="server" AssociatedUpdatePanelID="up">
                                <ProgressTemplate>
                                    <asp:Image ID="Image7" runat="server" ImageUrl="~/c-panel/images/ajax-loader.gif" />
                                </ProgressTemplate>
                            </asp:UpdateProgress>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <asp:Panel ID="pnlOps" runat="server" CssClass="col-md-12">
                                                ...
                                                <asp:Panel ID="pnlSearch" runat="server">
                                                    <div class="input-group" id="search">
                                                        ...
                                                        <span class="input-group-btn">
                                                            <asp:LinkButton ID="cmdSearch" CssClass="search-bt btn btn-default" runat="server" CausesValidation="False" OnClick="FillGrid"><i class="fa-search fa"></i></asp:LinkButton>
                                                        </span>
                                                    </div>
                                                </asp:Panel>
                                            </div>
                                            <asp:LinkButton ID="cmdNew" CssClass="btn-main btn-green fl-r mt5" Style="margin-top: 0px !important;" runat="server" OnClick="Add" ToolTip="New">New <i class="ti-plus"></i></asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </asp:Panel>
                                                    ...
                                                    <ul class="btn-uls mb0">
                                                        <li class="btn-lis">
                                                            <span style="position: relative;">
                                                                ...
                                                                <asp:Button ID="cmdSave" runat="server" CssClass="btn-main btn-green btn-save" ValidationGroup="vProduct" OnClick="Save" UseSubmitBehavior="false" OnClientClick="SaveClick(this,'vProduct');" Text="Save" />
                                                            </span>
                                                            <li class="btn-lis">
                                                                <asp:LinkButton ID="lbNoSave" runat="server" CssClass="btn-main btn-red" OnClientClick="CloseConfirmPopup('mpConfirmSave');return false;">No<i class="ti-close"></i></asp:LinkButton></li>
                                                    </ul>
                                                </div>
                                            </asp:Panel>
                                        ...
                                        <li class="btn-lis">
                                            ...
                                            <asp:Panel ID="pnlConfirmExtenderCancel" runat="server" ClientIDMode="Static" CssClass="modal-n modalPopup" align="center" Style="display: none">
                                                ...
                                                <div class="footer">
                                                    <ul class="btn-uls mb0">
                                                        <li class="btn-lis">
                                                            <asp:LinkButton ID="lbYesCancel" runat="server" CssClass="btn-main btn-green" OnClick="Cancel" CausesValidation="false">Yes<i class="ti-check"></i></asp:LinkButton></li>
                                                        <li class="btn-lis">
                                                            <asp:LinkButton ID="lbNoCancel" runat="server" CssClass="btn-main btn-red" OnClientClick="CloseConfirmPopup('mpConfirmCancel');return false;">No<i class="ti-close"></i></asp:LinkButton></li>
                                                    </ul>
                                                </div>
                                            </asp:Panel>
                                        </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="pnlUpload" runat="server" ClientIDMode="Static">
                                                                <asp:LinkButton CssClass="btn-main btn-green" ID="lbUpload" runat="server" OnClientClick="topFunction();">Upload Photos<i class="fa-plus fa"></i></asp:LinkButton>
                                                                ...
                                                                <asp:Panel ID="pnlFileUpload" runat="server" CssClass="modalPopup-uploader">
                                                                    <div class="modal-header">
                                                                        <asp:LinkButton ID="lbClosePopUp" CssClass="btn-main btn-close" runat="server" CausesValidation="false"><i class="ti-close icon-close""></i></asp:LinkButton>
                                                                    </div>
