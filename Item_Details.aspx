                                        ...
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <asp:ListView ID="lvPhotos" runat="server" >
                                                    <ItemTemplate>
                                                           <div class='<%# IIf(PublicFunctions.BoolFormat(Eval("main")), "carousel-item active", "carousel-item")%>'>
                                                    <img class="d-block w-100" src='<%# PublicFunctions.ServerURL & Eval("Photo")%>' alt='<%# Eval("Photo")%>'>
                                                </div>
                                                    </ItemTemplate>
                                                </asp:ListView>
                                                ...
                                                <asp:ListView ID="lvPhotosButtons" runat="server">
                                                    <ItemTemplate>
                                                        <li data-target="#carouselExampleIndicators" data-slide-to='<%# Container.DataItemIndex %>' class='<%# IIf(PublicFunctions.BoolFormat(Eval("main")), "active", "")%>'>
                                                            <img class="d-block w-100" src='<%# PublicFunctions.ServerURL & Eval("PhotoThumb")%>' alt='<%# Eval("PhotoThumb")%>'>
                                                        </li>
                                                    </ItemTemplate>
                                                </asp:ListView>
                                            </ol>
                                                ...
                                                <div class="media-object-section" style="padding: 0">
                                                    <a href='<%#PublicFunctions.ServerURL + "Brand=" + Eval("BrandName").ToString.Replace(" ", "-")  %>' title='<%# Eval("BrandName") %>' class="cont-logo">
                                                        <picture class="thumbnail logo-medium">
                                                            <img class="_logo" src='<%# PublicFunctions.ServerURL + Eval("BrandPhoto") %>' alt='<%# Eval("BrandName") %>' width="92" height="92">
                                                        </picture>
                                                    </a>
                                                </div>
                                            </div>
